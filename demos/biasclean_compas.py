# -*- coding: utf-8 -*-
"""BiasClean_Test.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EWwBcAUpzZEdU03EfQyzQtllOHnJfuBo
"""

# -*- coding: utf-8 -*-
"""Test 2_BiasClean_Domain.ipynb
...
class BiasClean:
    ...
    def _industry_smote_rebalancing(self, df: pd.DataFrame, diagnostic_results: dict, max_data_loss: float = 0.08) -> pd.DataFrame:
        ...
        logger.info(f"🎯 {self.domain.capitalize()} Priority Stack: {priority_stack}")
        ...
        if final_validation['success']:
            logger.success(f"✅ {self.domain.upper()} OPTIMIZATION SUCCESS")
            ...
            logger.warning(f"⚠️  {self.domain.capitalize()} optimization suboptimal - keeping improvements")
    ...
    def _multi_objective_optimization(self, df: pd.DataFrame, features: list, initial_disparities: dict, max_iterations: int = 10, domain_context: str = None) -> pd.DataFrame:
        ...
        logger.info(f"🚀 {domain_context.upper() if domain_context else 'MULTI-OBJECTIVE'} OPTIMIZATION: Simultaneous feature optimization")
