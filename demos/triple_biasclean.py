# -*- coding: utf-8 -*-
"""Triple_BiasClean.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1h55I0uxIoGRPSylD4dJHjXQEDeBRG4NV
"""

# -*- coding: utf-8 -*-
"""
Universal BiasClean Pipeline v2.1 - FIXED
...
# ============================================================================
# 1. HIERARCHICAL MAPPER (Domain-Aware)
# ============================================================================
...
def create_sample_health_dataset(n_samples: int = 2000, seed: int = 42) -> pd.DataFrame:
    ...
    Returns:
        DataFrame with biased healthcare data
    """
    np.random.seed(seed)
    ...
    # Create biased diagnosis outcome
    # Base rate: 20%
    base_rate = 0.20

    # Ethnicity-based bias
    ethnic_biases = {
        "White": base_rate * 0.90,     # 18% diagnosis (10% lower)
        "Black": base_rate * 1.40,     # 28% diagnosis (40% higher) - SIGNIFICANT BIAS
        "Asian": base_rate * 0.95,     # 19% diagnosis (5% lower)
        "Other": base_rate * 1.10      # 22% diagnosis (10% higher)
    }
    ...
    # Generate diagnosis with compound biases
    diagnoses = []
    for idx, row in df.iterrows():
        # Compound probability
...
def create_sample_finance_dataset(n_samples: int = 2000, seed: int = 42) -> pd.DataFrame:
    ...
    Returns:
        DataFrame with biased finance data
    """
    np.random.seed(seed)
    ...
    # Create biased loan approval outcome
    # Base rate: 65%
    base_rate = 0.65

    # Ethnicity-based bias
    ethnic_biases = {
        "White": base_rate * 1.15,     # 75% approval (15% higher)
        "Black": base_rate * 0.70,     # 46% approval (30% lower) - SIGNIFICANT BIAS
        "Asian": base_rate * 0.95,     # 62% approval (5% lower)
        "Other": base_rate * 0.85      # 55% approval (15% lower)
    }
    ...
    # Generate loan approval with compound biases
    approvals = []
    for idx, row in df.iterrows():
        # Compound probability
        prob = ethnic_biases[row["ethnicity"]]
...
def run_interactive_pipeline():
    ...
    # Option 1: Upload CSV or Option 2/3/4: Use sample data
    ...
    print("  2. Healthcare")
    print("  3. Finance")
    domain_choice = input("Enter choice (1, 2, or 3, default: 1): ").strip()
...
def quick_start_csv(file_path: str, target_column: str = None, domain: str = "justice"):
    ...
    Args:
        ...
        domain: Domain for analysis (justice, health, or finance)
...
def show_help():
    ...
    help_text = """
UNIVERSAL BIASCLEAN v2.1 - HELP (FIXED WEIGHT PRIORITIZATION)
...
DOMAIN WEIGHTS (FIXED PRIORITIZATION):
...
# Example 3: Health domain with weight prioritization
df = create_sample_health_dataset(n_samples=2000)
pipeline = UniversalBiasClean(domain='health', jurisdiction='NHS_England')
...
✓ Weight-Based Prioritization: Higher weight features mitigated first
✓ Domain-Specific Max Weight: Normalization per domain, not fixed 0.25
✓ Enhanced Logging: Shows mitigation order and intensity
✓ Weight Display: All reports show feature weights
✓ Domain-Aware Mapping: Different patterns per domain
...
def show_welcome():
    ...
    print("""
    ============================================================================
    UNIVERSAL BIASCLEAN v2.1 - FIXED WEIGHT-PRIORITIZED EDITION
    ============================================================================
    ...
    FIXED: Weight-based prioritization now works correctly for ALL domains
    ============================================================================
    """)
