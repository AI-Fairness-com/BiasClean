...
def analyze():
    ...
    try:
        ...
        # KEY FIX: Initialize pipeline with temp directory as results_dir
        # This enables visualizations to save to our controlled location
        pipeline = UniversalBiasClean(domain=domain, results_dir=viz_temp_dir)
        
        # DO NOT disable visualization methods - they are needed for PNG generation
        # All previous monkey patches that disabled viz.plot_* methods have been REMOVED
        ...
        # Collect any generated visualizations
