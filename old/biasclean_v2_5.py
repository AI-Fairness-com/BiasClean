# -*- coding: utf-8 -*-
"""BiasClean_7_SVM.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Dp6pmbCeCEZiuBeJzwe8bzMTPV8Tivee
"""
...
class SVMFairnessEnforcer:
    ...
    def __init__(self, domain_weights: Dict[str, float], random_state: int = 42):
        ...
        # SVM configuration optimized for fairness-aware classification
        self.svm_config = {
            'kernel': 'rbf',
            'C': 1.0,
            'gamma': 'scale',
...
class UniversalBiasClean:
    ...
    def process_dataset(self, file_path: str = None, df: pd.DataFrame = None,
        ...
        try:
            ...
            # ============================================================================
            # PHASE 8: RESULTS COMPILATION (WITH SVM INTEGRATION)
            # ============================================================================
            print(f"\n{'='*80}")
            ...
            self.results = {
                ...
                "validation": validation,
                "svm_validation": svm_validation,  # NEW: SVM results added here
                "target_column": final_target,
                "feature_map": feature_map,
                "metadata": {
                    "domain": self.domain,
                    ...
                    "svm_enabled": svm_validation.get('svm_applied', False)  # NEW: SVM flag
                }
            }
...
if __name__ == "__main__":
    print("Universal BiasClean7+SVM v2.5 - Core Pipeline Loaded Successfully.")
    print("For web service: Deploy biasclean_app.py to Render.")
    print("For programmatic use: Import UniversalBiasClean class.")
